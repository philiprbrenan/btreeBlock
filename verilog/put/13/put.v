...
reg [38:0] branch_0_StuckSA_Copy_80;  /*   MemoryLayoutPA.java:0978:declareVerilog   BtreePA.java:2296:stuckMemory   BtreePA.java:2280:stuckMemories   BtreePA.java:2533:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3603:<init>   BtreePA.java:3602:runVerilogPutTest   BtreePA.java:3727:test_verilog_put   BtreePA.java:3845:newTests   BtreePA.java:3851:main  */
...
reg[10: 0] copyLength_leaf_3_StuckSA_Memory_Based_100_base_offset;
  ...
  always @ (posedge reset, posedge clock) begin                                 // Execute next step in program
    ...
    if (reset) begin                                                            // Reset
      ...
      branch_0_StuckSA_Memory_Based_79_base_offset <= 0;branch_0_StuckSA_Copy_80 <= 0;branch_0_StuckSA_Transaction_81 <= 0; /*   BtreePA.java:2304:stuckMemoryInitialization   BtreePA.java:2289:stuckMemoryInitialization   BtreePA.java:2534:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3603:<init>   BtreePA.java:3602:runVerilogPutTest   BtreePA.java:3727:test_verilog_put   BtreePA.java:3845:newTests   BtreePA.java:3851:main  */branch_1_StuckSA_Memory_Based_82_base_offset <= 0;branch_1_StuckSA_Copy_83 <= 0;branch_1_StuckSA_Transaction_84 <= 0; /*   BtreePA.java:2304:stuckMemoryInitialization   BtreePA.java:2289:stuckMemoryInitialization   BtreePA.java:2534:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3603:<init>   BtreePA.java:3602:runVerilogPutTest   BtreePA.java:3727:test_verilog_put   BtreePA.java:3845:newTests   BtreePA.java:3851:main  */branch_2_StuckSA_Memory_Based_85_base_offset <= 0;branch_2_StuckSA_Copy_86 <= 0;branch_2_StuckSA_Transaction_87 <= 0; /*   BtreePA.java:2304:stuckMemoryInitialization   BtreePA.java:2289:stuckMemoryInitialization   BtreePA.java:2534:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3603:<init>   BtreePA.java:3602:runVerilogPutTest   BtreePA.java:3727:test_verilog_put   BtreePA.java:3845:newTests   BtreePA.java:3851:main  */branch_3_StuckSA_Memory_Based_88_base_offset <= 0;branch_3_StuckSA_Copy_89 <= 0;branch_3_StuckSA_Transaction_90 <= 0; /*   BtreePA.java:2304:stuckMemoryInitialization   BtreePA.java:2289:stuckMemoryInitialization   BtreePA.java:2534:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3603:<init>   BtreePA.java:3602:runVerilogPutTest   BtreePA.java:3727:test_verilog_put   BtreePA.java:3845:newTests   BtreePA.java:3851:main  */leaf_0_StuckSA_Memory_Based_91_base_offset <= 0;leaf_0_StuckSA_Copy_92 <= 0;leaf_0_StuckSA_Transaction_93 <= 0; /*   BtreePA.java:2304:stuckMemoryInitialization   BtreePA.java:2290:stuckMemoryInitialization   BtreePA.java:2534:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3603:<init>   BtreePA.java:3602:runVerilogPutTest   BtreePA.java:3727:test_verilog_put   BtreePA.java:3845:newTests   BtreePA.java:3851:main  */leaf_1_StuckSA_Memory_Based_94_base_offset <= 0;leaf_1_StuckSA_Copy_95 <= 0;leaf_1_StuckSA_Transaction_96 <= 0; /*   BtreePA.java:2304:stuckMemoryInitialization   BtreePA.java:2290:stuckMemoryInitialization   BtreePA.java:2534:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3603:<init>   BtreePA.java:3602:runVerilogPutTest   BtreePA.java:3727:test_verilog_put   BtreePA.java:3845:newTests   BtreePA.java:3851:main  */leaf_2_StuckSA_Memory_Based_97_base_offset <= 0;leaf_2_StuckSA_Copy_98 <= 0;leaf_2_StuckSA_Transaction_99 <= 0; /*   BtreePA.java:2304:stuckMemoryInitialization   BtreePA.java:2290:stuckMemoryInitialization   BtreePA.java:2534:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3603:<init>   BtreePA.java:3602:runVerilogPutTest   BtreePA.java:3727:test_verilog_put   BtreePA.java:3845:newTests   BtreePA.java:3851:main  */leaf_3_StuckSA_Memory_Based_100_base_offset <= 0;leaf_3_StuckSA_Copy_101 <= 0;leaf_3_StuckSA_Transaction_102 <= 0; /*   BtreePA.java:2304:stuckMemoryInitialization   BtreePA.java:2290:stuckMemoryInitialization   BtreePA.java:2534:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3603:<init>   BtreePA.java:3602:runVerilogPutTest   BtreePA.java:3727:test_verilog_put   BtreePA.java:3845:newTests   BtreePA.java:3851:main  */
    end
    else begin                                                                  // Run
