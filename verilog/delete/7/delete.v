...
reg [38:0] branch_0_StuckSA_Copy_12;  /*   MemoryLayoutPA.java:0978:declareVerilog   BtreePA.java:2296:stuckMemory   BtreePA.java:2280:stuckMemories   BtreePA.java:2533:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3491:<init>   BtreePA.java:3490:runVerilogDeleteTest   BtreePA.java:3585:test_verilog_delete   BtreePA.java:3843:newTests   BtreePA.java:3851:main  */
...
reg[10: 0] copyLength_leaf_3_StuckSA_Memory_Based_32_base_offset;
  ...
  always @ (posedge reset, posedge clock) begin                                 // Execute next step in program
    ...
    if (reset) begin                                                            // Reset
      ...
      branch_0_StuckSA_Memory_Based_11_base_offset <= 0;branch_0_StuckSA_Copy_12 <= 0;branch_0_StuckSA_Transaction_13 <= 0; /*   BtreePA.java:2304:stuckMemoryInitialization   BtreePA.java:2289:stuckMemoryInitialization   BtreePA.java:2534:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3491:<init>   BtreePA.java:3490:runVerilogDeleteTest   BtreePA.java:3585:test_verilog_delete   BtreePA.java:3843:newTests   BtreePA.java:3851:main  */branch_1_StuckSA_Memory_Based_14_base_offset <= 0;branch_1_StuckSA_Copy_15 <= 0;branch_1_StuckSA_Transaction_16 <= 0; /*   BtreePA.java:2304:stuckMemoryInitialization   BtreePA.java:2289:stuckMemoryInitialization   BtreePA.java:2534:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3491:<init>   BtreePA.java:3490:runVerilogDeleteTest   BtreePA.java:3585:test_verilog_delete   BtreePA.java:3843:newTests   BtreePA.java:3851:main  */branch_2_StuckSA_Memory_Based_17_base_offset <= 0;branch_2_StuckSA_Copy_18 <= 0;branch_2_StuckSA_Transaction_19 <= 0; /*   BtreePA.java:2304:stuckMemoryInitialization   BtreePA.java:2289:stuckMemoryInitialization   BtreePA.java:2534:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3491:<init>   BtreePA.java:3490:runVerilogDeleteTest   BtreePA.java:3585:test_verilog_delete   BtreePA.java:3843:newTests   BtreePA.java:3851:main  */branch_3_StuckSA_Memory_Based_20_base_offset <= 0;branch_3_StuckSA_Copy_21 <= 0;branch_3_StuckSA_Transaction_22 <= 0; /*   BtreePA.java:2304:stuckMemoryInitialization   BtreePA.java:2289:stuckMemoryInitialization   BtreePA.java:2534:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3491:<init>   BtreePA.java:3490:runVerilogDeleteTest   BtreePA.java:3585:test_verilog_delete   BtreePA.java:3843:newTests   BtreePA.java:3851:main  */leaf_0_StuckSA_Memory_Based_23_base_offset <= 0;leaf_0_StuckSA_Copy_24 <= 0;leaf_0_StuckSA_Transaction_25 <= 0; /*   BtreePA.java:2304:stuckMemoryInitialization   BtreePA.java:2290:stuckMemoryInitialization   BtreePA.java:2534:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3491:<init>   BtreePA.java:3490:runVerilogDeleteTest   BtreePA.java:3585:test_verilog_delete   BtreePA.java:3843:newTests   BtreePA.java:3851:main  */leaf_1_StuckSA_Memory_Based_26_base_offset <= 0;leaf_1_StuckSA_Copy_27 <= 0;leaf_1_StuckSA_Transaction_28 <= 0; /*   BtreePA.java:2304:stuckMemoryInitialization   BtreePA.java:2290:stuckMemoryInitialization   BtreePA.java:2534:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3491:<init>   BtreePA.java:3490:runVerilogDeleteTest   BtreePA.java:3585:test_verilog_delete   BtreePA.java:3843:newTests   BtreePA.java:3851:main  */leaf_2_StuckSA_Memory_Based_29_base_offset <= 0;leaf_2_StuckSA_Copy_30 <= 0;leaf_2_StuckSA_Transaction_31 <= 0; /*   BtreePA.java:2304:stuckMemoryInitialization   BtreePA.java:2290:stuckMemoryInitialization   BtreePA.java:2534:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3491:<init>   BtreePA.java:3490:runVerilogDeleteTest   BtreePA.java:3585:test_verilog_delete   BtreePA.java:3843:newTests   BtreePA.java:3851:main  */leaf_3_StuckSA_Memory_Based_32_base_offset <= 0;leaf_3_StuckSA_Copy_33 <= 0;leaf_3_StuckSA_Transaction_34 <= 0; /*   BtreePA.java:2304:stuckMemoryInitialization   BtreePA.java:2290:stuckMemoryInitialization   BtreePA.java:2534:editVariables   BtreePA.java:2528:editVariables   BtreePA.java:2498:<init>   BtreePA.java:3491:<init>   BtreePA.java:3490:runVerilogDeleteTest   BtreePA.java:3585:test_verilog_delete   BtreePA.java:3843:newTests   BtreePA.java:3851:main  */
    end
    else begin                                                                  // Run
...
if (2 >= 0) begin
  M_9[branch_3_StuckSA_Memory_Based_20_base_offset+         23/*data    */ + 2 * 4 +: 4] <= branch_3_StuckSA_Copy_21[      23/*data    */ + 3 * 4 +: 4];
          ...
          194 : begin
                    leaf_2_StuckSA_Transaction_31[      33/*copyBitsKeys    */ +: 8] <= leaf_2_StuckSA_Transaction_31[      30/*copyCount       */ +: 3]*5; /*   StuckPA.java:0203:<init>   StuckPA.java:0202:copyKeys   StuckPA.java:0224:copyKeysData   StuckPA.java:0749:prepend   BtreePA.java:1644:Then   ProgramPA.java:0239:<init>   BtreePA.java:1623:<init>   BtreePA.java:1622:code   ProgramPA.java:0270:<init>   BtreePA.java:1586:<init>   BtreePA.java:1585:mergeLeftSibling   BtreePA.java:1823:code   ProgramPA.java:0270:<init>   BtreePA.java:1803:<init>   BtreePA.java:1802:balance   BtreePA.java:2178:code   ProgramPA.java:0270:<init>   BtreePA.java:2163:<init>   BtreePA.java:2162:code   ProgramPA.java:0270:<init>   BtreePA.java:2142:<init>   BtreePA.java:2141:delete   BtreePA.java:3527:test_verilog_delete   BtreePA.java:3843:newTests   BtreePA.java:3851:main  */
...
if (copyLength_leaf_2_StuckSA_Memory_Based_29_base_offset >= 1) begin
   ...
   index_leaf_2_StuckSA_Memory_Based_29_base_offset = index_leaf_2_StuckSA_Memory_Based_29_base_offset + 1;
          ...
          204 : begin
                    branch_2_StuckSA_Transaction_19[      33/*copyBitsKeys    */ +: 8] <= branch_2_StuckSA_Transaction_19[      30/*copyCount       */ +: 3]*5; /*   StuckPA.java:0203:<init>   StuckPA.java:0202:copyKeys   StuckPA.java:0224:copyKeysData   StuckPA.java:0749:prepend   BtreePA.java:1681:Else   ProgramPA.java:0254:<init>   BtreePA.java:1623:<init>   BtreePA.java:1622:code   ProgramPA.java:0270:<init>   BtreePA.java:1586:<init>   BtreePA.java:1585:mergeLeftSibling   BtreePA.java:1823:code   ProgramPA.java:0270:<init>   BtreePA.java:1803:<init>   BtreePA.java:1802:balance   BtreePA.java:2178:code   ProgramPA.java:0270:<init>   BtreePA.java:2163:<init>   BtreePA.java:2162:code   ProgramPA.java:0270:<init>   BtreePA.java:2142:<init>   BtreePA.java:2141:delete   BtreePA.java:3527:test_verilog_delete   BtreePA.java:3843:newTests   BtreePA.java:3851:main  */
...
if (2 >= branch_1_StuckSA_Transaction_16[      21/*index   */ +: 3]) begin
  M_9[branch_1_StuckSA_Memory_Based_14_base_offset+         23/*data    */ + 2 * 4 +: 4] <= branch_1_StuckSA_Copy_15[      23/*data    */ + 3 * 4 +: 4];
          ...
          219 : begin
                    leaf_2_StuckSA_Transaction_31[      33/*copyBitsKeys    */ +: 8] <= leaf_2_StuckSA_Transaction_31[      30/*copyCount       */ +: 3]*5; /*   StuckPA.java:0203:<init>   StuckPA.java:0202:copyKeys   StuckPA.java:0224:copyKeysData   StuckPA.java:0719:concatenate   BtreePA.java:1741:Then   ProgramPA.java:0239:<init>   BtreePA.java:1719:<init>   BtreePA.java:1718:code   ProgramPA.java:0270:<init>   BtreePA.java:1696:<init>   BtreePA.java:1695:mergeRightSibling   BtreePA.java:1824:code   ProgramPA.java:0270:<init>   BtreePA.java:1803:<init>   BtreePA.java:1802:balance   BtreePA.java:2178:code   ProgramPA.java:0270:<init>   BtreePA.java:2163:<init>   BtreePA.java:2162:code   ProgramPA.java:0270:<init>   BtreePA.java:2142:<init>   BtreePA.java:2141:delete   BtreePA.java:3527:test_verilog_delete   BtreePA.java:3843:newTests   BtreePA.java:3851:main  */
                    leaf_2_StuckSA_Transaction_31[      41/*copyBitsData    */ +: 7] <= leaf_2_StuckSA_Transaction_31[      30/*copyCount       */ +: 3]*4;
