...
""");
        case 30 -> t.ok("""
          ...
          1          3               4                                8                10            9          |
                                     7                                                               2          |
1,2,3,4=1  5,6,7,8=3    9,10,11,12=4    13,14,15,16=7   17,18,19,20=8   21,22,23,24=10    25,26,27=9    28,29=2 |
""");
        case 29 -> t.ok("""
                                                      16                                                |
                                                      0                                                 |
...
""");
        case 26 -> t.ok("""
          ...
          1          3               4                                8             10         |
                                     7                                              9          |
1,2,3,4=1  5,6,7,8=3    9,10,11,12=4    13,14,15,16=7   17,18,19,20=8   21,22,23=10    24,25=9 |
""");
        case 25 -> t.ok("""
                                                      16                               |
                                                      0                                |
...
""");
        case 22 -> t.ok("""
          ...
          1          3                               7            8           |
                     4                                            10          |
1,2,3,4=1  5,6,7,8=3    9,10,11,12=4   13,14,15,16=7   17,18,19=8    20,21=10 |
""");
        case 21 -> t.ok("""
                                     12                              |
                                     0                               |
...
""");
        case 18 -> t.ok("""
          ...
          1                        4            7          |
          3                                     8          |
1,2,3,4=1  5,6,7,8=3  9,10,11,12=4   13,14,15=7    16,17=8 |
""");
        case 17 -> t.ok("""
                     8                             |
                     0                             |
...
""");
        case 14 -> t.ok("""
          ...
          1          3            4          |
                                  7          |
1,2,3,4=1  5,6,7,8=3    9,10,11=4    12,13=7 |
""");
        case 13 -> t.ok("""
          4          8               |
          0          0.1             |
