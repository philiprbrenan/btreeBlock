...
dot.node('B',    'The Btree algorithm\nin normal Java',               fontcolor='red', style='bold', fontsize='20')
...
dot.edge('S',    'SS'   , arrowhead='diamond', color='blue')
dot.edge('SS',   'SSML' , arrowhead='diamond', color='blue')
dot.edge('SSML', 'SSP'  , arrowhead='diamond', color='blue')
dot.edge('SSP',  'SSA'  , arrowhead='diamond', color='blue')
dot.edge('SSA',  'SPA'  , arrowhead='diamond', color='blue')
dot.edge('SPA',  'SDM'  , arrowhead='diamond', color='blue')

dot.edge('MPA',  'MDM'  , arrowhead='diamond', color='blue')
...
dot.edge('LBAM', 'BAM'  , arrowhead='diamond', color='blue')
dot.edge('LBAM', 'BAN'  , arrowhead='diamond', color='blue')
dot.edge('LBAM', 'LBAP' , arrowhead='diamond', color='blue')
dot.edge('LBAP', 'BAP'  , arrowhead='diamond', color='blue')
