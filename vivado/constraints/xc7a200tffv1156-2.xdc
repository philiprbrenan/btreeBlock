set_property PACKAGE_PIN Y1  [get_ports clock]
set_property PACKAGE_PIN Y2  [get_ports reset]
set_property PACKAGE_PIN Y3  [get_ports found]
set_property PACKAGE_PIN Y5  [get_ports stop]
...
set_property PACKAGE_PIN Y10 [get_ports {Key[3]}]
set_property PACKAGE_PIN Y21 [get_ports {Key[4]}]
set_property PACKAGE_PIN Y26 [get_ports {Data[0]}]
set_property PACKAGE_PIN Y27 [get_ports {Data[1]}]
set_property PACKAGE_PIN Y28 [get_ports {Data[2]}]
set_property PACKAGE_PIN Y30 [get_ports {Data[3]}]
set_property PACKAGE_PIN Y31 [get_ports {data[0]}]
set_property PACKAGE_PIN Y32 [get_ports {data[1]}]
set_property PACKAGE_PIN Y33 [get_ports {data[2]}]
set_property PACKAGE_PIN V32 [get_ports {data[3]}]
