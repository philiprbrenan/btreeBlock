...
The logs of the successful synthesis of the individual components of [Database on a Chip](http://prb.appaapps.com/zesal/pitchdeck/pitchDeck.html) on [Vivado](https://en.wikipedia.org/wiki/Xilinx_Vivado): 
