...
increase the number of keys in each branch and leaf in the [B-Tree](https://en.wikipedia.org/wiki/B-tree). 
...
Use OpenRam for [memory](https://en.wikipedia.org/wiki/Computer_memory) 